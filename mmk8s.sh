...
sudo kubeadm init --control-plane-endpoint "$IP:6443" --upload-certs --apiserver-advertise-address $RIP --pod-network-cidr 192.168.0.0/16 --image-repository docker.arvancloud.ir/kubesphere --kubernetes-version 1.27.1 
